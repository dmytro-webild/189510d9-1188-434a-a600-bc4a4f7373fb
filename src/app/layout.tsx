...
export const metadata: Metadata = {
  title: "Sammy's Tire Service - Fast Tire Repair & Installation Joliet",
  description: "Fast & affordable tire service in Joliet, IL. Tire repair, installation, balancing & more. Same-day service available. Call (815) 722-9514.",
  keywords: "tire shop Joliet, tire repair Joliet IL, cheap tires Joliet, flat tire repair near me, used tires Joliet, tire installation",
  metadataBase: new URL("https://sammystireservice.com"),
  alternates: {
    canonical: "https://sammystireservice.com",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Sammy's Tire Service - Fast Tire Repair in Joliet",
    description: "Professional tire installation, repair & balancing in Joliet. Same-day service. Fair pricing. Call (815) 722-9514.",
    url: "https://sammystireservice.com",
    siteName: "Sammy's Tire Service",
    type: "website",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/car-mechanic-trying-set-socket-auto-wheel_23-2147897836.jpg",
        alt: "Sammy's Tire Service - Professional tire repair shop",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Sammy's Tire Service - Fast Tire Repair Joliet",
    description: "Professional tire installation, repair & balancing. Same-day service available.",
    images: ["http://img.b2bpic.net/free-photo/car-mechanic-trying-set-socket-auto-wheel_23-2147897836.jpg"],
  },
};
